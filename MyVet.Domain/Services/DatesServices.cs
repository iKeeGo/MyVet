...
namespace MyVet.Domain.Services
{
    public class DatesServices : IDatesServices
    {
        ...
        #region Builder
        public DatesServices(UnitOfWork unitOfWork)
        {
        ...
        public List<DatesDto> GetAllMyDates(int idUser)
        {
            ...
            List<DatesDto> listDates = dates.Select(x => new DatesDto
            {
                ...
                Servicio = x.ServicesEntity.Services,
        ...
        public List<DatesDto> GetAllMyPets(int idUser)
        {
            var dates = _unitOfWork.PetRepository.FindAll(x => x.UserPetEntity.IdUser == idUser,
                                                        p => p.UserPetEntity).ToList();
        ...
        public List<ServicesEntity> GetAllServices() => _unitOfWork.ServicesRepository.GetAll().ToList();
