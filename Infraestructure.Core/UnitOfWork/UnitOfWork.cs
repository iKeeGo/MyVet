...
namespace Infraestructure.Core.UnitOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private bool disposed = false; //libere espacio de la memoria

        #endregion Attributes

        #region builder

        public UnitOfWork(DataContext context) //Acceso a datos @context@
        {
        ...
        #region Members
        public IRepository<UserEntity> UserRepository // Propiedades que se van a utilizar
        {
            get
            {
        ...
        public async Task<int> Save() => await _context.SaveChangesAsync(); //Guardar Cambios
    }
}